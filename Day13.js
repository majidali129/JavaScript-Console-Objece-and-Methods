...
// console.log('%c Majid Ali' , 'color:orange')
// console.log("%cmajidAli%c '%csajadAli%c" , 'color:blue' , "color:yellowgreen")
...
// let names = ["Majid Ali" , "age" , 34, 000 , undefined]
...
// console.assert(10>2*10 , "condition is false")

// console.warn("Be aware. You can never master JavaScript without practice")
// console.error("Browser console.error() method is use to show error message on browser console.")
...
// for of loop is faster than while , traditional for loop and forEach method 
